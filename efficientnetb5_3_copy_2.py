...
plt.ylabel("Accuracy")
plt.legend()
plt.savefig(f'result/eff_aug_acc_bs{batch_size}_e{epoch}_color_lr{learning_rate}_nn{node_size}_c{NUM_CLASSES}_fr{isFreeze}.png')
plt.close()
...
plt.ylabel("Loss")
plt.legend()
plt.savefig(f'result/eff_aug_lost_bs{batch_size}_e{epoch}_color_lr{learning_rate}_nn{node_size}_c{NUM_CLASSES}_fr{isFreeze}.png')
plt.close()
...
# # Save the model
model.save(f'model/eff_aug_inception_bs{batch_size}_e{epoch}_lr{learning_rate}_nn{node_size}_c{NUM_CLASSES}_fr{isFreeze}.h5')
